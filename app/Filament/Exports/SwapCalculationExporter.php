...
class SwapCalculationExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('currency_pair_id')->label('Currency Pair ID'),
            ExportColumn::make('pair.symbol')->label('Currency Pair Symbol'),
            ExportColumn::make('lot_size'),
            ExportColumn::make('position_type'),
            ExportColumn::make('swap_rate'),
            ExportColumn::make('days'),
            ExportColumn::make('total_swap'),
